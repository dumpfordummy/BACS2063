 ...
 */
public class RemoveTutor extends javax.swing.JDialog {

    /**
     * Creates new form RemoveDialog
     */
    public RemoveTutor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        displayTutorList();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveTutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RemoveTutor dialog = new RemoveTutor(new javax.swing.JFrame(), true);
